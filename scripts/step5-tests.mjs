...
must('lib/crm.js',['xzrecruiter_crm_dispatch','referenceContext','search','saveClient','saveContact','saveOpportunity','moveOpportunity','saveTask','saveContract','saveCustomValues']);
