...
const required = [
  ...
  'app/settings/global/page.js','app/components/Brand.js','app/components/AppShell.js','app/components/WorkspaceSelector.js','app/components/CommandPalette.js',
  ...
  'app/step2.css','lib/db.js','lib/auth.js','lib/globalization.js','lib/global-context.js','i18n/resources.js','public/xzrecruiter-logo.svg',
...
const hardening = fs.readFileSync('supabase/migrations/20260903_step2_global_integrity_hardening.sql','utf8');
...
if (/\bdrop\s+table\b|\btruncate\b|\bdelete\s+from\b/i.test(`${migration}\n${hardening}`)) throw new Error('Destructive Step-2 migration statement detected');
...
if (!hardening.includes('interviews_timezone_iana_check') || !hardening.includes('taxonomy_labels_agency')) throw new Error('Global integrity hardening missing');
