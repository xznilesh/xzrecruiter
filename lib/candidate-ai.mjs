...
export function createCandidateInputHash({resumeText='',candidateProfile={},requirementContext={},sourceMeta={}}={}){
  const material=sanitizeCandidateText(resumeText)+'|'+safeJson(candidateProfile,50000)+'|'+safeJson(requirementContext,50000)+'|'+safeJson(sourceMeta,12000);
