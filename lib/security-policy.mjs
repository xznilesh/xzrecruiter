...
export const ROLE_PERMISSIONS=Object.freeze({
  ...
  ACCOUNT_MANAGER:Object.freeze([
    ...
    'document:resume_view','document:sensitive_view','document:review','audit:view'
  ]),
  RECRUITER:Object.freeze([
    'candidate:view','candidate:edit','candidate:screen',
    'submission:create','document:resume_view'
  ]),
...
export function hasPermission(role,permission){
  const permissions=ROLE_PERMISSIONS[canonicalRole(role)]||[];
