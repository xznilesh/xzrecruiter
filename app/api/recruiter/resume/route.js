...
export async function POST(req){
  ...
  try{
    ...
    await recruiterAction('finalizeResume',{jobId,parseRunId:prepared.parse_run_id,error:'storage_upload_failed'}).catch(()=>null);
  ...
  try{
    ...
    await recruiterAction('finalizeResume',{jobId,parseRunId:prepared.parse_run_id,error:error?.message||'parse_failed'}).catch(()=>null);
