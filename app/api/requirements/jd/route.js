...
export async function POST(req){
  if(!mutationRequestIsTrusted(req))return responseError('invalid_request_origin',403);
  if(!declaredBodyWithin(req,512*1024))return responseError('request_too_large',413);
  let body;
